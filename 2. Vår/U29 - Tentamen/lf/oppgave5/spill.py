...
while kjorer:
    ...
    poeng_spiller_2 = font.render(str(spiller1.poeng), True, "white")
    vindu.blit(poeng_spiller_2, (25, 25))
    poeng_spiller_1 = font.render(str(spiller2.poeng), True, "white")
    vindu.blit(poeng_spiller_1, (BREDDE - 50, 25))
